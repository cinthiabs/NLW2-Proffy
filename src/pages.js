const Database = require('./database/banco') // chamando o banco

const {subjects,weekdays,getSubject,converHoursToMinutes} = require('./utils/format')

 function pageLanding(req,res){
    return res.render("index.html")//mostrando o projeto inicial
}
...
async function pageStudy(req,res){
    ...
    if(!filters.subject || !filters.weekday || !filters.time){
        return res.render("study.html",{filters, subjects, weekdays})//mostrando o projeto study
    }
    //converter hora
...
function pageGiveClasses(req, res){ 
    return res.render("give-classes.html",{subjects, weekdays})//mostrando o projeto give
}
